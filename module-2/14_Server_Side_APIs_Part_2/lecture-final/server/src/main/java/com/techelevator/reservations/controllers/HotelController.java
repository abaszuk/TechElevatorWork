...
public class HotelController {
  ...
  //  @Autowired
    ...
    public Reservation updateReservation(@PathVariable int id, @RequestBody @Valid Reservation reservation){

        /*
        if(reservation.getGuests() == 0){
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "Must have more than 0 guests");
        }*/
