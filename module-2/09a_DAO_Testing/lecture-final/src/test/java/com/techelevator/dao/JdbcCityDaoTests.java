...
public class JdbcCityDaoTests extends BaseDaoTests {
    ...
    private static final City CITY_1 =
            new City(1, "City 1", "AA", 11, 111);
    private static final City CITY_2 =
            new City(2, "City 2", "BB", 22, 222);
    private static final City CITY_4 =
            new City(4, "City 4", "AA", 44, 444);
    ...
    public void createCity_creates_city() {
        ...
        //Arrange
        City newCity = new City(0, "Test City", "CC", 99, 999);

        //Act
        City createdCity = sut.createCity(newCity);
