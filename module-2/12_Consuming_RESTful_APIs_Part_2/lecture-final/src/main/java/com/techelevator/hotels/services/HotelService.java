...
public class HotelService {
    ...
    public Reservation addReservation(Reservation newReservation) {
        // Let's set up our http request to indicate we are including json data
        // and then we can actually attach the object to our request
       HttpEntity<Reservation> request = makeRequest(newReservation);

        Reservation result = null;

        try {
            String url= API_BASE_URL + "/reservations";
            result = restTemplate.postForObject(url, request , Reservation.class );
    ...
    private HttpEntity<Reservation> makeRequest(Reservation reservation) {
    ...
    public boolean updateReservation(Reservation updatedReservation) {
        ...
        HttpEntity<Reservation> request = makeRequest(updatedReservation);
