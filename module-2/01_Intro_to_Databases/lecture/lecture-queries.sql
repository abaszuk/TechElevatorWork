...
-- IS null is necessary when we are looking for null values in a column
...
SELECT park_name, area as area_in_kilometers, area *1000 * 1000 AS area_in_square_meters
FROM park;
...
-- using the % sign is the wild card operator indicating that 'anything can go here'
SELECT city_name
FROM city
