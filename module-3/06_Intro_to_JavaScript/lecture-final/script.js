...
function variables() {
  ...
  //instead of System.out.println in java we can say console.log in javascript
...
let objects = () => {
  ...
  //We can dynamically add new fields
  ...
  //foreach loop
  for(let name of person.employees){
    console.log(name);
  }
...
function mathFunctions() {
  ...
  //if we want to parse an int from a string
  let myInt = parseInt("50");
  console.log(myInt);

  let myFloat = parseFloat("2.3");
  console.log(myFloat);
}
